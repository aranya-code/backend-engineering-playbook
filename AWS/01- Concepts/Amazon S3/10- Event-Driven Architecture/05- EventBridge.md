...
EventBridge adds rule-based routing, archive and replay, and cross-account integration. Validate that the object and version referenced by the event remain accessible.
