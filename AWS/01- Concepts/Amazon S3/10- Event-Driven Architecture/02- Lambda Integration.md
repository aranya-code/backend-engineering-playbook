...
Lambda works for small stateless reactions such as validation or dispatch. Put heavy or bursty work behind SQS, set concurrency deliberately, and avoid re-triggering the same prefix.
