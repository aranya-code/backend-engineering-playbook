...
SSE-S3 is the automatic baseline for new objects. Use SSE-KMS for customer-managed keys, enforce intent in policy, and validate KMS permissions with the real application role.
