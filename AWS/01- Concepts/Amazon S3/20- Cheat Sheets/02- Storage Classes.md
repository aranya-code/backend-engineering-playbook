...
Use Standard for active data, Intelligent-Tiering for unknown access, IA for predictable infrequent access, Glacier for archive recovery objectives, and S3 Express One Zone only for suitable single-AZ latency workloads.
