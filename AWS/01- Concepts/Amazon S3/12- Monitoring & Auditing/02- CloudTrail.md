...
CloudTrail records management events and can record S3 data events. Scope data events to high-value buckets or prefixes, centralize them, and protect the log destination.
