...
Versioning makes lifecycle two-dimensional: current versions, noncurrent versions, and expired delete markers need separate actions. Set a recovery window before expiring historical data.
