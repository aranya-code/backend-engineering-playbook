...
For each scenario, draw request flow, identity path, key contract, async state transitions, encryption boundary, observability signals, and RPO/RTO. Explain why alternatives lose.
