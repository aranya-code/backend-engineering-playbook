...
FastAPI works well as a signing and orchestration service: authenticate, authorize a key and checksum, issue a short-lived request, and process completion through durable background work.
