...
Multipart failures often involve credentials, part numbers or ETags, completion manifest, timeouts, or lifecycle abort. Persist upload state and retry parts safely.
