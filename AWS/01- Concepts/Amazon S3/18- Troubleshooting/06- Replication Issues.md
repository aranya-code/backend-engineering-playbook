...
Check versioning, filters, rule priority, source role, destination policy, KMS grants, object eligibility, and pending metrics. Test with a new version of a known small object.
