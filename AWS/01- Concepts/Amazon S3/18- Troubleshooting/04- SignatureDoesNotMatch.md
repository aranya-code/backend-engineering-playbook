...
SignatureDoesNotMatch means the canonical request differs from what was signed. Compare method, host and region, URI encoding, query parameters, signed headers, clock, and proxy behavior.
