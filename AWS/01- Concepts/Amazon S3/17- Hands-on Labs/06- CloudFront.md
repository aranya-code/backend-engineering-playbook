...
Place CloudFront before a private S3 origin, use Origin Access Control, choose cache and error policy, and test versioned keys versus invalidation with headers that prove CDN delivery.
