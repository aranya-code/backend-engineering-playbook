...
Lifecycle rules select objects by prefix, tags, and size filters, then schedule transition or expiry. Treat those filters as a versioned contract with data producers.
