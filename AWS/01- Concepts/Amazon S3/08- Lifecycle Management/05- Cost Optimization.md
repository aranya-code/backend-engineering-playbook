...
Lifecycle optimization starts from observed object age, size, and access frequency. Validate against a representative distribution before applying a policy broadly.
