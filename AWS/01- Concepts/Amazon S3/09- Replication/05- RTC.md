...
Replication Time Control is an S3 SLA-backed option for most new-object replication within a defined objective. Use it when an auditable RPO justifies its cost.
