...
Overview is a production decision point. Define its assumptions in code, policy, and runbooks so behavior remains predictable under retries, growth, and incidents.
