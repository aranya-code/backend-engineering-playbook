...
Backups need independent restore testing, deletion protection, retention classes, encryption, account or region isolation, and evidence that data can be restored by the application.
