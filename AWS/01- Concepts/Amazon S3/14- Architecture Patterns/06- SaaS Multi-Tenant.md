...
In SaaS, tenant identity must be enforced in authorization, not only encoded in a prefix. Use session tags, access points, or a signing service and meter usage by tenant.
