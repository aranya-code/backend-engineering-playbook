...
Data transfer depends on source, destination, region, edge service, and direction. Keep compute close to data where practical and budget for egress and cross-region reads.
