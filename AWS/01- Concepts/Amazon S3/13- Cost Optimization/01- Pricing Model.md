...
S3 pricing combines stored bytes, API requests, retrieval, transfer, replication, management features, and optional acceleration. Price a workload trace rather than a headline storage rate.
