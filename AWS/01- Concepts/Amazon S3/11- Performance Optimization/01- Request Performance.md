...
Request performance depends on object size, concurrency, connection reuse, retry strategy, geographic placement, and post-GET work. Measure the complete path before changing key layout.
