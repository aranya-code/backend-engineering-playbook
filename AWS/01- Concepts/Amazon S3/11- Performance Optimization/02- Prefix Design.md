...
S3 scales request throughput across prefixes automatically. Design keys for tenant isolation, lifecycle filters, bulk operations, and investigation rather than artificial randomization.
