...
A presigned URL is a bearer credential. Authorize before issuing it, scope it to one method and key, constrain headers where possible, and use the shortest practical expiration.
