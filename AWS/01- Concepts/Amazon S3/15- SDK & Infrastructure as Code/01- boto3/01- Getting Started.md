...
Create one configured S3 client per process with explicit region, bounded retries, connection and read timeouts, and workload identity. Never embed long-lived access keys in settings.
