...
Sync is convenient for bulk copy and static deploys, but review delete behavior with a dry run and do not mistake it for backup retention or integrity verification.
