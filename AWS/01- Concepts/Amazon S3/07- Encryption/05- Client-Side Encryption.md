...
Client-side encryption protects plaintext before S3 receives it, but shifts key management, metadata format, rotation, range reads, and recovery into the application.
