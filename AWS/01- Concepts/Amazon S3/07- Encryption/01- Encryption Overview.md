...
S3 automatically applies SSE-S3 to new object uploads as a baseline. Use SSE-KMS when customer-managed key controls, key-policy separation, or KMS audit evidence are requirements.
