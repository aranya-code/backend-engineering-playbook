...
SSE-S3 uses S3-managed AES-256 keys and does not add per-request KMS authorization or KMS request cost. It is a strong default for data that needs encryption at rest without customer-managed key controls.
