...
KMS errors can arise from Encrypt, Decrypt, or DataKey permission, key policy trust, disabled keys, region mismatch, encryption-context conditions, or throttling. Inspect both S3 and KMS evidence.
