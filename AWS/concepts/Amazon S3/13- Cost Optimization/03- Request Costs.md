...
High-frequency small-object operations can make request charges dominate. Batch where semantics allow, cache safely, avoid repeated LIST scans, and model retries.
