...
Django storage backends are convenient, but production systems still need explicit bucket, key, cache, upload, and authorization policy. Do not serve every media byte through Django.
