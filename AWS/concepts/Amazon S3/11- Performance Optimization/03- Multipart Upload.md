...
Multipart upload enables parallel transfer and per-part retry. Choose part size and concurrency from client memory and network limits, persist upload state, and abort incomplete uploads on a schedule.
