...
Range GET avoids downloading unused bytes and permits segment retries or parallel reads. It is valuable for media and file inspection when ETag or version changes are handled.
