...
Storage Lens provides account and organization-level activity and optimization metrics. Use it to identify inactive data, encryption gaps, ownership settings, and anomalous growth.
