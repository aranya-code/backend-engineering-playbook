...
Server access logging provides request records for traffic analysis. Deliver to a dedicated protected bucket and use CloudTrail data events when you need API-level audit evidence.
