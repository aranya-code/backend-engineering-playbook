...
S3 exposes storage and request metrics with feature-specific granularity and cost. Alarm on symptoms tied to an owner action, not on metrics that no one can investigate.
