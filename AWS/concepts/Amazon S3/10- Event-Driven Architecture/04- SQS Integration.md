...
SQS provides durable buffering and controlled concurrency. Configure visibility timeout, DLQ, redrive, and idempotency; acknowledge only after the durable business outcome succeeds.
