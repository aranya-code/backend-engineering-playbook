...
A robust upload flow is authorize and sign, direct upload, durable event, validate and scan, transform, then mark the domain record ready. PUT success should not mean published.
