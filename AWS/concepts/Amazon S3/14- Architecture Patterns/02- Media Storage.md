...
Media storage needs original and derivative key conventions, validation, lifecycle, CDN caching, and access control. Keep originals immutable so failed transforms cannot overwrite valid assets.
