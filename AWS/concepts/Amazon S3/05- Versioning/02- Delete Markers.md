...
A normal delete in a versioned bucket creates a current delete marker. GET without a version ID returns not found, while a privileged caller can remove the marker or retrieve a prior version.
