...
MFA Delete requires human confirmation for permanent version deletion and versioning changes. It is intentionally operationally restrictive and should be selected only where its root-account control model is acceptable.
