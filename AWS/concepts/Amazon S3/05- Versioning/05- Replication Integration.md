...
Replication applies to object versions. Decide independently whether to replicate delete markers, replica modifications, and existing objects; a delete marker is not a retention policy.
