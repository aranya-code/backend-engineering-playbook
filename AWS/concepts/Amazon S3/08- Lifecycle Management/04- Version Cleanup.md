...
Noncurrent-version transitions and expiry control the true cost of versioning. Preserve enough history for detection and rollback, then clean up deliberately.
