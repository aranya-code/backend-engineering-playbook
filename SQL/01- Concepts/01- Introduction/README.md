...
| # | File | Description |
|---|---|---|
| 01 | [01- What Is SQL](./01-%20What%20Is%20SQL.md) | What SQL is and what problem it solves |
| 02 | [02- SQL and Relational Databases](./02-%20SQL%20and%20Relational%20Databases.md) | How SQL relates to the relational model |
| 03 | [03- SQL Standards and Database Dialects](./03-%20SQL%20Standards%20and%20Database%20Dialects.md) | Standard SQL versus database-specific implementations |
| 04 | [04- SQL Execution Model](./04-%20SQL%20Execution%20Model.md) | What the database does when it receives and executes SQL |
| 05 | [05- SQL for Backend Engineers](./05-%20SQL%20for%20Backend%20Engineers.md) | How SQL fits into real backend systems |
| 06 | [06- SQL Learning Strategy](./06-%20SQL%20Learning%20Strategy.md) | How to learn and practice SQL for backend engineering |
